...
public interface OtherApi {
     ...
     * 退出系统(注销 重启 关机)
     *
     * @param type 取值为以下类型 0: 注销系统 1: 关机 2: 重新启动
     * @return 0: 失败 1: 成功
     */
    @ComMethod
     ...
     * 得到系统的路径
     *
     * @param type 取值为以下类型 0: 获取当前路径 1: 获取系统路径(system32路径) 2: 获取windows路径(windows所在路径) 3: 获取临时目录路径(temp) 4: 获取当前进程(exe)所在的路径
     * @return 返回路径
     */
    @ComMethod
     ...
     * 设置当前系统的UAC(用户账户控制).
     *
     * @param enable 取值如下 0: 关闭UAC 1: 开启UAC
